            ...
            {/* <div className="w-[35%] bg-[#101010] h-[770px] rounded-[4px] px-3 py-5">
              <div className="flex flex-col gap-[12px] px-4 py-6 w-[100%] bg-[#000000] rounded-[8px]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-[10px]">
                    <h3 className="text-[12px] font-[400] text-[#FFFFFF]/75">
                      $5,784,043.78
                    </h3>
                    <Image
                    ...
                    />
                    <h3 className="text-[12px] font-[400] text-[#08E04A]">
                      80%
                    </h3>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-[10px] items-center justify-center">
                  <h2 className="text-[10px] font-[400] text-[#FFFFFF]/75">
                    SALE ENDS IN
                  </h2>
              ...
              <div className="flex flex-col gap-[12px] px-4 py-6 w-[100%] bg-[#000000] border border-[#282828] rounded-tl-[8px] rounded-tr-[8px] mt-[20px]">
                ...
                <div className="flex gap-[2px] mt-[-10px]">
                  ...
                  <div className="w-[35%] h-[58px] bg-[#101010] flex items-center gap-[5px] pl-[10px] rounded-tr-[8px] rounded-br-[8px]">
                    <Image
                      ...
                      alt="usdt logo"
                    />
                    <span className="text-[12px] font-[400] text-[#FFFFFF]/70">
                      USDT
                    </span>
                  </div>
                </div>
                <h3 className="text-[12px] font-[400] text-[#FFFFFF]/70">
                  You Get
                </h3>
                ...
                <h3 className="text-[10px] font-[400] w-[100%] mt-[20px] text-[#FFFFFF]/70">
                  By contributing to the presale you acknowledge and accept
                  these{" "}
              ...
              <div className="flex items-center w-[100%] pl-3 h-[86px] border border-[#282828] rounded-bl-[8px] bg-[#000000] rounded-br-[8px] bg-[url('/ads-bg-img.png')] bg-right bg-no-repeat bg-[length:120px_80px]">
                <h3 className="w-[173px] text-[12px] font-[400] ml-[8px] leading-[18px]">
                  A chance to buy Kar tokens at half of the launch price
                </h3>
              </div>
              <div className="flex items-center w-[100%] justify-between mt-[15px]">
                <span className="w-[130px] h-[36px] text-[12px] font-[400] text-[#FFFFFF]/30">
                  Copyright © 2024 Kar. All rights reserved.
                </span>
                <span className="w-[110px] h-[18px] text-[12px] font-[400] text-[#FFFFFF]/30">
                  Gaziantep, Türkiye
                </span>
              </div>
            </div> */}
      ...
      {/* <main className="mmd:hidden flex flex-col min-h-screen py-[30px] px-[15px]">
        ...
        {isContribute === false ? (
          <div className="overflow-y-auto">
            <h2 className="text-[24px] font-[600] mt-[40px] pl-[8px]">
              Token Sale DApp
            </h2>
            <div className="w-[100%] bg-[#101010] h-[257px] rounded-[8px] px-3 py-4 mt-[30px]">
              <div className="flex flex-col gap-[12px] px-4 py-6 w-[100%] bg-[#000000] rounded-[8px]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-[10px]">
                    <h3 className="text-[14px] font-[400] text-[#FFFFFF]/75">
                      $5,784,043.78
                    </h3>
                    <Image
                      src="/currency-divider.png"
                      ...
                      className="cursor-pointer"
                    />
                    <h3 className="text-[14px] font-[400] text-[#08E04A]">
                      80%
                    </h3>
                  </div>
                </div>
                ...
                />
                <div className="flex flex-col gap-[10px] items-center justify-center">
                  <h2 className="text-[12px] font-[400] text-[#FFFFFF]/75">
                    SALE ENDS IN
                  </h2>
              ...
              <button
                onClick={() => setIsContribute(true)}
                className=" flex items-center justify-center gap-[10px] w-[100%] h-[48px] bg-[#08E04A] text-[16px] font-[700] text-[#000000] rounded-[8px] mt-[10px]"
              >
            ...
            <div className="flex flex-col w-[100%] bg-[#101010] px-5 py-8 justify-between gap-[10px] mt-[3px]">
              ...
              <h6 className="text-[12px] font-[400] text-[#FFFFFF]/50">
                Copy your unique referral code and earn 2.5% commissions from
                every investment made by your referred investors.
              </h6>
              <div className="w-[100%] bg-[#000000] h-[32px] rounded-[4px] flex items-center justify-between pl-[8px] pr-[14px] cursor-pointer">
                <h5 className="text-[14px] font-[400] text-[#FFFFFF]/70">
                  https://kar.com/78236-tube...
                </h5>
              ...
              <div className="w-[100%] flex gap-[10px] items-center cursor-pointer">
                <div className="flex items-center gap-[10px] mt-[15px]">
                  <h4 className="text-[14px] font-[400] text-[#FFFFFF]/50">
                    Share on
                  </h4>
            ...
            <div className="w-[100%] bg-[#101010] flex flex-col justify-between rounded-bl-[8px] rounded-br-[8px]">
              <div className="w-[100%] flex flex-col gap-[30px] p-5">
                ...
                <div className="flex flex-col gap-[30px]">
                  <div className="flex flex-col gap-[10px]">
                    <h4 className="text-[12px] font-[400] text-[#FFFFFF]/70">
                      AMOUNT SPENT
                    </h4>
                    <div className="text-[28px] font-[300] flex">
                      <span>21,325</span>
                      <span className="text-[10px] font-[300] mt-[10px]">
                        .45
                      </span>
                  ...
                  <div className="flex flex-col gap-[10px]">
                    ...
                    <div className="text-[28px] font-[300] flex items-center">
                      <span>345</span>
                      <span className="text-[10px] font-[300] mt-[-6px]">
                        .45
                      </span>
                      <span className="ml-[3px] text-[#FFFFFF]/70">USDT</span>
                      <BsArrowUp className="text-[14px] font-[300] text-[#08E04A] ml-[4px]" />
                      <span className="text-[14px] font-[300] text-[#08E04A] ml-[4px]">
                        100%
                      </span>
                    </div>
                  </div>
              ...
              <table className="flex flex-col w-[100%] border-[#000000] rounded-[4px] h-[600px] px-[5px]">
                <tbody className="text-[12px] w-[100%] bg-[#000000] border-[#000000] px-[10px] h-[600px] overflow-y-scroll">
                  {tableData.map((data, index) => (
                    <tr
                      key={index}
                      className="flex w-[100%] items-center border-1 border-b-[#151515] justify-between py-[14px]"
                    >
                      ...
                      <td className="flex flex-col items-start w-[72px] font-[400] ml-[-10px]">
                        <div className="text-[16px]">
                          <span>{data.tokens_got}</span>
                          <span className="font-[400] text-[#FFFFFF]/70 ml-[2px]">
                            KAR
                          </span>
                        </div>
                        <span className="mt-[2px] text-[12px] text-[#049330]">
                          {data.action}
                        </span>
                      </td>
          ...
          <>
            <div
              onClick={() => setIsContribute(false)}
              className="flex items-center gap-[4px] cursor-pointer text-[14px] font-[400] text-[#08E04A] mt-[20px]"
            >
            ...
            <div className="flex flex-col gap-[12px] px-2 py-6 w-[100%] rounded-tl-[8px] rounded-tr-[8px]">
              ...
              <h3 className="text-[14px] font-[400] text-[#FFFFFF]/70">
                You Get
              </h3>
              <div className="flex gap-[2px]">
              ...
              <h3 className="text-[12px] font-[400] w-[100%] mt-[20px] text-[#FFFFFF]/70">
                By contributing to the presale you acknowledge and accept these{" "}
                <span className="text-[#FFFFFF] underline cursor-pointer">
                  terms and conditions.
                </span>
              </h3>
